...
def validate_and_clean_data(df, target, task_type='regression'):
    """
    Validate and clean uploaded data for regression.
    ...
    try:
        ...
        errors.append("Target column contains non-numeric values. Regression requires numeric targets.")
        return None, None, errors, warnings
    ...
    if df_cleaned.shape[1] < 1:
        errors.append("Need at least 1 numeric feature for regression.")
        return None, None, errors, warnings
            ...
            try:
                ...
                if len(df.columns) < 2:
                    ...
                    if target_col:
                        ...
                        df, target, errors, warnings = validate_and_clean_data(df, target, 'regression')
        ...
        if st.button("Train Model", type="primary"):
            with st.spinner("Training model..."):
                try:
                    ...
                    st.error("Matrix is singular. This can happen when features are perfectly correlated or there are more features than samples. Try removing redundant features or using more data.")
